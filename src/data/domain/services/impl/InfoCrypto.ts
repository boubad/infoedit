...
export function b64_md5(s: any)    { return rstr2b64(rstr_md5(str2rstr_utf8(s))); }
export function any_md5(s: any, e: any) { return rstr2any(rstr_md5(str2rstr_utf8(s)), e); }
export function hex_hmac_md5(k: any, d: any)
  { return rstr2hex(rstr_hmac_md5(str2rstr_utf8(k), str2rstr_utf8(d))); }
export function b64_hmac_md5(k: any, d: any)
  { return rstr2b64(rstr_hmac_md5(str2rstr_utf8(k), str2rstr_utf8(d))); }
export function any_hmac_md5(k: any, d: any, e: any)
 ...
 */
export function str2rstr_utf16le(input: { length: number; charCodeAt: { (arg0: number): number; (arg0: number): number; }; })
{
  let output = "";
  for(let i = 0; i < input.length; i++) {
// tslint:disable-next-line: no-bitwise
...
export function str2rstr_utf16be(input: { length: number; charCodeAt: { (arg0: number): number; (arg0: number): number; }; })
{
  let output = "";
  for(let i = 0; i < input.length; i++) {
    // tslint:disable-next-line:no-bitwise
