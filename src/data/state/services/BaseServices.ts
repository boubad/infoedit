import { GetControle, GetEtudiant } from '../../../data/domain/DataProcs';
import { IControleDoc, IEtudiantDoc, IEvtDoc, INoteDoc } from '../../../data/domain/DomainData';
import { DataPersistManager } from '../../../data/domain/services/DataPersistManager';
import { DataStoreFactory } from '../../../data/domain/services/impl/DataStoreFactory';
...
export class BaseServices {
  ...
  public static getPersistManager(state: IInfoState): DataPersistManager {
    ...
    const pFact = new DataStoreFactory();
    const pStore = pFact.GetRemoteStore(url,name);
