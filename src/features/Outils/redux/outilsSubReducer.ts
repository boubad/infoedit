...
import { CHANGE_ANNEE_SUCCESS, CHANGE_GROUPE_SUCCESS, CHANGE_SEMESTRE_SUCCESS } from '../../../features/AppState/redux/AppStateActions';
import { ETUDAFFECTATION_REMOVE_ATTACHMENT_SUCCESS, ETUDAFFECTATION_SAVE_ATTACHMENT_SUCCESS, GOTO_PAGE_ETUDAFFECTATION_SUCCESS, REMOVE_ETUDAFFECTATION_ITEM_SUCCESS, SAVE_ETUDAFFECTATION_ITEM_SUCCESS } from '../../../features/EtudAffectation/redux/EtudAffectationActions';
import { CHANGESTATUS_ETUDIANT_SUCCESS, REMOVE_ETUDIANT_ITEM_SUCCESS, SAVE_ETUDIANT_ITEM_SUCCESS } from '../../../features/Etudiant/redux/EtudiantActions';
import { IInfoState } from '../../../redux/InfoState';
import { IOutilsState } from '../../../redux/InfoState';
import { InfoAction } from '../../../redux/IPayload';
import { IMPORT_ETUDIANT_BEGIN, IMPORT_ETUDIANT_SUCCESS, REFRESHANNEESEMESTRE_STATUS_BEGIN, REFRESHANNEESEMESTRE_STATUS_SUCCESS } from './OutilsActions';
//////////////////////////////////////////
export function outilsSubReducer(
  ...
  switch (action.type) {
    ...
    case REFRESHANNEESEMESTRE_STATUS_BEGIN:
      return produce(state.outils, pRet => {
        pRet.busy = true;
      });
